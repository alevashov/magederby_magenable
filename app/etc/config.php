...
return [
    'modules' => [
        ...
        'MageSuite_Media' => 1,
        'MageSuite_Navigation' => 1,
        'MageSuite_Opengraph' => 1,
        'MageSuite_Pagination' => 1,
        'MageSuite_PersistentSitemap' => 1,
        'MageSuite_ProductBestsellersRanking' => 1,
